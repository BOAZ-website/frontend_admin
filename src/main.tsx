...
class GlobalErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 select-none" style={{ fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>
          <div className="max-w-md w-full bg-white rounded-3xl p-8 border border-slate-200/90 shadow-xl shadow-slate-200/50 text-center space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs sm:text-sm text-slate-500 font-medium leading-relaxed">
                서비스 이용 중 일시적인 문제가 발생했습니다.<br />
                문제가 지속될 경우 <span className="font-bold text-slate-700">관리자(서비스운영팀)</span>에게 문의해 주세요.
              </p>
            </div>
            ...
            <div className="space-y-2.5 pt-2">
              ...
              <button
                type="button"
                onClick={() => {
                  alert("BOAZ 서비스운영팀 (카카오톡 채널 @BOAZ 또는 운영진 슬랙)으로 문의해 주시기 바랍니다.");
                }}
