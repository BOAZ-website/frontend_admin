...
const ACTIVITY_TYPE_META: Record<InternalActivityType, { label: string; short: string; color: string; bg: string; border: string; icon: any }> = {
  SESSION: { label: "정규 세션", short: "세션", color: "#1d4ed8", bg: "#eff6ff", border: "#bfdbfe", icon: Calendar },
  STUDY:   { label: "스터디", short: "스터디", color: "#0369a1", bg: "#f0f9ff", border: "#bae6fd", icon: BookOpen },
  ADV:     { label: "어드밴스드 (어드브)", short: "어드브", color: "#7e22ce", bg: "#faf5ff", border: "#e9d5ff", icon: Rocket },
  ETC:     { label: "기타 내부 활동", short: "기타", color: "#475569", bg: "#f8fafc", border: "#e2e8f0", icon: Layers },
};
...
const INITIAL_INTERNAL_ATTENDEES: AttendeeRecord[] = [
  // 1. 3주차 정규 세션
  { id: "att_s1_1", eventId: "evt_sess_03", isExternal: false, name: "김서하", affiliation: "28기 분석", term: 28, email: "seoha.k@yonsei.ac.kr", phone: "010-5519-8821", status: "present", checkedInAt: "13:50" },
  { id: "att_s1_2", eventId: "evt_sess_03", isExternal: false, name: "이민준", affiliation: "28기 분석", term: 28, email: "minjun.l@snu.ac.kr", phone: "010-3811-9021", status: "present", checkedInAt: "13:52" },
  { id: "att_s1_3", eventId: "evt_sess_03", isExternal: false, name: "박지훈", affiliation: "28기 분석", term: 28, email: "jihoon.p@korea.ac.kr", phone: "010-4491-3829", status: "present", checkedInAt: "13:55" },
  { id: "att_s1_4", eventId: "evt_sess_03", isExternal: false, name: "정채원", affiliation: "28기 분석", term: 28, email: "chaewon.j@hanyang.ac.kr", phone: "010-9920-1182", status: "present", checkedInAt: "13:58" },
  { id: "att_s1_5", eventId: "evt_sess_03", isExternal: false, name: "오승현", affiliation: "28기 분석", term: 28, email: "seunghyun.o@sogang.ac.kr", phone: "010-3378-4912", status: "absent", checkedInAt: "-", memo: "사전 공결 신청 승인" },
  { id: "att_s1_6", eventId: "evt_sess_03", isExternal: false, name: "이도현", affiliation: "28기 엔지니어링", term: 28, email: "dohyun.l@snu.ac.kr", phone: "010-3819-2910", status: "present", checkedInAt: "13:45" },
  { id: "att_s1_7", eventId: "evt_sess_03", isExternal: false, name: "박성훈", affiliation: "28기 엔지니어링", term: 28, email: "sunghoon.p@naver.com", phone: "010-9182-4122", status: "late", checkedInAt: "14:15", memo: "15분 지각" },
  { id: "att_s1_8", eventId: "evt_sess_03", isExternal: false, name: "강태양", affiliation: "28기 엔지니어링", term: 28, email: "taeyang.k@snu.ac.kr", phone: "010-1829-4720", status: "present", checkedInAt: "13:50" },
  { id: "att_s1_9", eventId: "evt_sess_03", isExternal: false, name: "임수진", affiliation: "28기 엔지니어링", term: 28, email: "sujin.l@yonsei.ac.kr", phone: "010-8831-2940", status: "present", checkedInAt: "13:54" },
  { id: "att_s1_10", eventId: "evt_sess_03", isExternal: false, name: "최민혁", affiliation: "28기 시각화", term: 28, email: "minhyuk.c@yonsei.ac.kr", phone: "010-5512-7019", status: "present", checkedInAt: "13:48" },
  { id: "att_s1_11", eventId: "evt_sess_03", isExternal: false, name: "한예린", affiliation: "28기 시각화", term: 28, email: "yerin.h@ewha.ac.kr", phone: "010-6629-3810", status: "present", checkedInAt: "13:51" },
  { id: "att_s1_12", eventId: "evt_sess_03", isExternal: false, name: "윤재혁", affiliation: "28기 시각화", term: 28, email: "jaehyuk.y@skku.edu", phone: "010-4490-1822", status: "present", checkedInAt: "13:53" },
  { id: "att_s1_13", eventId: "evt_sess_03", isExternal: false, name: "장나연", affiliation: "28기 시각화", term: 28, email: "nayeon.j@hanyang.ac.kr", phone: "010-8812-7091", status: "unmarked", checkedInAt: "-" },

  // 2. 머신러닝 스터디 3회차
  { id: "att_st_1", eventId: "evt_study_ml", isExternal: false, name: "이민준", affiliation: "28기 분석", term: 28, email: "minjun.l@snu.ac.kr", phone: "010-3811-9021", status: "present", checkedInAt: "18:50" },
  { id: "att_st_2", eventId: "evt_study_ml", isExternal: false, name: "김서하", affiliation: "28기 분석", term: 28, email: "seoha.k@yonsei.ac.kr", phone: "010-5519-8821", status: "present", checkedInAt: "18:55" },
  { id: "att_st_3", eventId: "evt_study_ml", isExternal: false, name: "정채원", affiliation: "28기 분석", term: 28, email: "chaewon.j@hanyang.ac.kr", phone: "010-9920-1182", status: "present", checkedInAt: "18:58" },
  { id: "att_st_4", eventId: "evt_study_ml", isExternal: false, name: "고준서", affiliation: "27기 분석", term: 27, email: "junseo.k@snu.ac.kr", phone: "010-2281-9930", status: "present", checkedInAt: "18:45" },
  { id: "att_st_5", eventId: "evt_study_ml", isExternal: false, name: "박지훈", affiliation: "28기 분석", term: 28, email: "jihoon.p@korea.ac.kr", phone: "010-4491-3829", status: "present", checkedInAt: "19:00" },
  { id: "att_st_6", eventId: "evt_study_ml", isExternal: false, name: "오승현", affiliation: "28기 분석", term: 28, email: "seunghyun.o@sogang.ac.kr", phone: "010-3378-4912", status: "absent", checkedInAt: "-", memo: "개인 일정" },
  { id: "att_st_7", eventId: "evt_study_ml", isExternal: false, name: "최민혁", affiliation: "28기 시각화", term: 28, email: "minhyuk.c@yonsei.ac.kr", phone: "010-5512-7019", status: "present", checkedInAt: "18:52" },
  { id: "att_st_8", eventId: "evt_study_ml", isExternal: false, name: "한예린", affiliation: "28기 시각화", term: 28, email: "yerin.h@ewha.ac.kr", phone: "010-6629-3810", status: "present", checkedInAt: "18:48" },

  // 3. 어드밴스드 중간 점검
  { id: "att_adv_1", eventId: "evt_adv_mid", isExternal: false, name: "김서하", affiliation: "28기 분석", term: 28, email: "seoha.k@yonsei.ac.kr", phone: "010-5519-8821", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_2", eventId: "evt_adv_mid", isExternal: false, name: "이민준", affiliation: "28기 분석", term: 28, email: "minjun.l@snu.ac.kr", phone: "010-3811-9021", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_3", eventId: "evt_adv_mid", isExternal: false, name: "이도현", affiliation: "28기 엔지니어링", term: 28, email: "dohyun.l@snu.ac.kr", phone: "010-3819-2910", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_4", eventId: "evt_adv_mid", isExternal: false, name: "강태양", affiliation: "28기 엔지니어링", term: 28, email: "taeyang.k@snu.ac.kr", phone: "010-1829-4720", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_5", eventId: "evt_adv_mid", isExternal: false, name: "최민혁", affiliation: "28기 시각화", term: 28, email: "minhyuk.c@yonsei.ac.kr", phone: "010-5512-7019", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_6", eventId: "evt_adv_mid", isExternal: false, name: "문지훈", affiliation: "27기 시각화", term: 27, email: "jihoon.m@korea.ac.kr", phone: "010-4481-9012", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_7", eventId: "evt_adv_mid", isExternal: false, name: "고준서", affiliation: "27기 분석", term: 27, email: "junseo.k@snu.ac.kr", phone: "010-2281-9930", status: "unmarked", checkedInAt: "-" },
  { id: "att_adv_8", eventId: "evt_adv_mid", isExternal: false, name: "남소희", affiliation: "27기 엔지니어링", term: 27, email: "sohee.n@yonsei.ac.kr", phone: "010-3391-7721", status: "unmarked", checkedInAt: "-" },
];

export function InternalAttendanceManagePage() {
  const [subTab, setSubTab] = useState<"live" | "events">("events");
  const [activityCategoryFilter, setActivityCategoryFilter] = useState<"ALL" | InternalActivityType>("ALL");
  ...
  const filteredEvents = events.filter(e => {
    if (activityCategoryFilter !== "ALL" && e.type !== activityCategoryFilter) return false;
  ...
  const filteredAttendees = currentEventAttendees.filter(a => {
    ...
    if (trackFilter !== "ALL") {
      if (trackFilter === "ANALYSIS" && !a.affiliation.includes("분석")) return false;
      if (trackFilter === "ENGINEERING" && !a.affiliation.includes("엔지니어링")) return false;
      if (trackFilter === "VISUALIZATION" && !a.affiliation.includes("시각화")) return false;
    }
    if (attendeeSearch.trim()) {
      ...
      if (!matchName && !matchAffil && !matchMemo) return false;
    }
    return true;
  });
    ...
    setAttendees(prev => prev.map(a => {
      if (a.id === attendeeId) {
        return {
          ...a,
          status: newStatus,
          checkedInAt: (newStatus === "present" || newStatus === "late") && a.checkedInAt === "-" ? nowTime : a.checkedInAt,
        };
      }
      return a;
    }));
  ...
  function handleAddMemberToRoster() {
    ...
    const trackLabel = newMemberTrack === "ANALYSIS" ? "분석" : newMemberTrack === "ENGINEERING" ? "엔지니어링" : "시각화";
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 sm:gap-5 py-1 px-1 text-xs text-slate-500 flex-wrap border-b border-slate-100 pb-3 font-medium">
            ...
            <div className="flex items-center gap-1.5">
              ...
              >
                <span>{selectedEvent.checkinMethod === "CODE" ? `코드 (${selectedEvent.checkinCode})` : selectedEvent.checkinMethod === "QR_CODE" ? "QR 코드" : "수기 체크"}</span>
              ...
              <table className="w-full text-xs min-w-[700px] table-fixed">
                <thead>
                  <tr className="border-b border-slate-200/80 bg-slate-50/70 text-slate-600 font-semibold text-xs whitespace-nowrap">
                    ...
                    {isTableEditMode && (
                      <th className="text-center px-3 py-3 w-14 text-slate-400">
                        삭제
                      </th>
                    )}
                  </tr>
                ...
                <tbody className="divide-y divide-slate-100 font-mono">
                  {filteredAttendees.length === 0 ? (
                    <tr>
                      <td colSpan={isTableEditMode ? 7 : 6} className="py-16 text-center text-slate-500 space-y-2">
                        <UserCheck size={32} className="mx-auto text-slate-300 mb-1" />
                        <p className="font-bold text-slate-800 text-sm">해당 조건의 참가자가 없습니다.</p>
                        <p className="text-xs">상단의 <strong>[+ 1명 부원 추가]</strong>로 등록하거나 검색어를 변경하세요.</p>
                      </td>
                    </tr>
                  ) : (
                    filteredAttendees.map((att, idx) => (
                      <tr
                        key={att.id}
                        className="hover:bg-slate-50/70 transition-colors h-[48px]"
                      >
          ...
          <div className="flex items-center justify-between flex-wrap gap-2 border-b border-slate-100 pb-3">
            <div className="flex items-center gap-1.5 flex-wrap">
              {[
                ...
                { id: "SESSION", label: "정규 세션", count: events.filter(e => e.type === "SESSION").length },
                { id: "STUDY", label: "스터디", count: events.filter(e => e.type === "STUDY").length },
                { id: "ADV", label: "어드밴스드 (어드브)", count: events.filter(e => e.type === "ADV").length },
                { id: "ETC", label: "기타 활동", count: events.filter(e => e.type === "ETC").length },
              ].map(cat => {
          ...
          <div className="grid grid-cols-1 gap-3">
            {filteredEvents.length === 0 ? (
              <div className="p-12 text-center text-slate-400 bg-white rounded-2xl border border-slate-200 space-y-1">
                ...
                <p className="text-xs">상단의 [+ 새 활동/세션 생성] 버튼으로 새로운 세션을 등록하세요.</p>
              </div>
            ) : (
              filteredEvents.map(evt => {
                ...
                const attended = evtAttendees.filter(a => a.status === "present" || a.status === "late").length;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6 shrink-0">
                      ...
                      <ChevronRight size={16} className="text-slate-300 group-hover:text-slate-700 transition-colors" />
                    </div>
                  </div>
                );
              })
        ...
        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="w-full max-w-lg rounded-2xl overflow-hidden p-6 space-y-4 bg-white border border-slate-200 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
            ...
            <div className="space-y-3.5 text-xs">
              {/* Category Select */}
              <div>
                <label className="text-slate-600 font-bold block mb-1.5">활동 성격 분류 (필수)</label>
              ...
              <div>
                <label className="text-slate-600 font-bold block mb-1.5">세부 설명 / 안건 (선택)</label>
                <textarea
                  value={newEventDesc}
        ...
        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-xs">
          <div className="w-full max-w-sm rounded-2xl overflow-hidden p-6 space-y-4 bg-white border border-slate-200 shadow-2xl text-center">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 text-left">
              ...
              <button onClick={() => setShowCheckinModal(false)} className="text-slate-400 hover:text-slate-700 cursor-pointer">
                <X size={16} />
              </button>
            </div>

            <div className="py-2 space-y-3">
              <span className="text-xs text-slate-500 font-semibold">부원 현장 출석 체크인 코드</span>
              ...
              <p className="text-[11px] text-slate-400 leading-tight">
                부원들이 모바일 출석 체크 페이지에서 위 4자리 코드를 입력하면 실시간 출석 처리됩니다.
              </p>
            </div>
