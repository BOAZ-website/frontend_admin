...
import type { ScoreRule } from "../../App";
import {
  Calendar, Clock, Users, UserCheck, Plus, Edit3, Trash2,
  FileSpreadsheet, QrCode, Search, Filter, CheckCircle2,
  AlertCircle, ChevronRight, ChevronLeft, X, Copy, ExternalLink, ShieldCheck,
  ...
  BookOpen, Rocket, Presentation, CheckCircle, MapPin, Key, Maximize2, Minimize2, ChevronsRight,
  SlidersHorizontal, MoreHorizontal, Camera, ZoomIn, ImageIcon, RotateCcw, ArrowUpDown
} from "lucide-react";
...
export type AttendStatus = "present" | "late" | "earlyLeave" | "absent" | "excusedAbsent" | "remote" | "unexcusedLate" | "unexcusedAbsent" | "unmarked";
...
const CATEGORY_CONFIG: Record<InternalCategory, {
  title: string;
  subTitle: string;
  icon: any;
  themeColor: string;
  ...
  SESSION: {
    ...
    teamLabel: "트랙",
    teams: [
      { id: "base_analysis", name: "분석", leader: "김서하", description: "데이터 분석 & 머신러닝", memberCount: 6 },
      { id: "base_vis", name: "시각화", leader: "최민혁", description: "데이터 시각화 & 대시보드", memberCount: 5 },
      { id: "base_eng", name: "엔지니어링", leader: "강태양", description: "데이터 엔지니어링 & MLOps", memberCount: 5 },
    ],
    initialEvents: [
      {
        id: "evt_sess_03",
    ...
    initialAttendees: [
      { id: "att_s_1", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "김서하", term: 28, track: "분석", status: "present", checkedInAt: "13:50" },
      { id: "att_s_2", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "정채원", term: 28, track: "분석", status: "present", checkedInAt: "13:54" },
      { id: "att_s_3", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "박지훈", term: 28, track: "분석", status: "present", checkedInAt: "13:58" },
      { id: "att_s_4", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "이민준", term: 28, track: "분석", status: "present", checkedInAt: "13:48" },
      { id: "att_s_5", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "고준서", term: 27, track: "분석", status: "present", checkedInAt: "13:52" },
      { id: "att_s_6", eventId: "evt_sess_03", teamId: "base_analysis", teamName: "분석", name: "오승현", term: 28, track: "분석", status: "absent", checkedInAt: "-", memo: "사전 공결 신청 승인" },

      { id: "att_s_7", eventId: "evt_sess_03", teamId: "base_vis", teamName: "시각화", name: "최민혁", term: 28, track: "시각화", status: "present", checkedInAt: "13:47" },
      { id: "att_s_8", eventId: "evt_sess_03", teamId: "base_vis", teamName: "시각화", name: "한예린", term: 28, track: "시각화", status: "present", checkedInAt: "13:51" },
      { id: "att_s_9", eventId: "evt_sess_03", teamId: "base_vis", teamName: "시각화", name: "윤재혁", term: 28, track: "시각화", status: "present", checkedInAt: "13:53" },
      { id: "att_s_10", eventId: "evt_sess_03", teamId: "base_vis", teamName: "시각화", name: "문지훈", term: 27, track: "시각화", status: "present", checkedInAt: "13:56" },
      { id: "att_s_11", eventId: "evt_sess_03", teamId: "base_vis", teamName: "시각화", name: "장나연", term: 28, track: "시각화", status: "late", checkedInAt: "14:10", memo: "10분 지각" },

      { id: "att_s_12", eventId: "evt_sess_03", teamId: "base_eng", teamName: "엔지니어링", name: "강태양", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:42" },
      { id: "att_s_13", eventId: "evt_sess_03", teamId: "base_eng", teamName: "엔지니어링", name: "이도현", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:45" },
      { id: "att_s_14", eventId: "evt_sess_03", teamId: "base_eng", teamName: "엔지니어링", name: "임수진", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:56" },
      { id: "att_s_15", eventId: "evt_sess_03", teamId: "base_eng", teamName: "엔지니어링", name: "백민혁", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:59" },
      { id: "att_s_16", eventId: "evt_sess_03", teamId: "base_eng", teamName: "엔지니어링", name: "남소희", term: 27, track: "엔지니어링", status: "present", checkedInAt: "13:40" },
    ],
  },
  STUDY: {
    title: "스터디 출결 관리",
    ...
    teamLabel: "스터디 팀",
    teams: [
      { id: "study_a", name: "A팀 (머신러닝 & 딥러닝 실전)", leader: "이민준", description: "논문 리뷰 및 캐글 경진대회 베이스라인 구축", memberCount: 4 },
      { id: "study_b", name: "B팀 (대용량 분산 데이터 파이프라인)", leader: "강태양", description: "Kafka & Spark 기반 실시간 ETL 파이프라인", memberCount: 4 },
      { id: "study_c", name: "C팀 (Tableau & D3.js 대시보드)", leader: "문지훈", description: "인터랙티브 웹 데이터 시각화 & 대시보드", memberCount: 4 },
      { id: "study_d", name: "D팀 (LLM Agent & RAG 시스템)", leader: "고준서", description: "LangChain & LlamaIndex 기반 프로덕션 RAG", memberCount: 4 },
    ],
    initialEvents: [
      {
        id: "evt_std_03",
    ...
    initialAttendees: [
      { id: "att_st_a1", eventId: "evt_std_03", teamId: "study_a", teamName: "A팀 (머신러닝 & 딥러닝 실전)", name: "이민준", term: 28, track: "분석", status: "present", checkedInAt: "18:50" },
      { id: "att_st_a2", eventId: "evt_std_03", teamId: "study_a", teamName: "A팀 (머신러닝 & 딥러닝 실전)", name: "김서하", term: 28, track: "분석", status: "present", checkedInAt: "18:55" },
      { id: "att_st_a3", eventId: "evt_std_03", teamId: "study_a", teamName: "A팀 (머신러닝 & 딥러닝 실전)", name: "정채원", term: 28, track: "분석", status: "present", checkedInAt: "18:58" },
      { id: "att_st_a4", eventId: "evt_std_03", teamId: "study_a", teamName: "A팀 (머신러닝 & 딥러닝 실전)", name: "오승현", term: 28, track: "분석", status: "absent", checkedInAt: "-", memo: "개인 일정 불참" },

      { id: "att_st_b1", eventId: "evt_std_03", teamId: "study_b", teamName: "B팀 (대용량 분산 데이터 파이프라인)", name: "강태양", term: 28, track: "엔지니어링", status: "present", checkedInAt: "18:45" },
      { id: "att_st_b2", eventId: "evt_std_03", teamId: "study_b", teamName: "B팀 (대용량 분산 데이터 파이프라인)", name: "이도현", term: 28, track: "엔지니어링", status: "present", checkedInAt: "18:48" },
      { id: "att_st_b3", eventId: "evt_std_03", teamId: "study_b", teamName: "B팀 (대용량 분산 데이터 파이프라인)", name: "임수진", term: 28, track: "엔지니어링", status: "present", checkedInAt: "18:52" },
      { id: "att_st_b4", eventId: "evt_std_03", teamId: "study_b", teamName: "B팀 (대용량 분산 데이터 파이프라인)", name: "백민혁", term: 28, track: "엔지니어링", status: "present", checkedInAt: "18:59" },

      { id: "att_st_c1", eventId: "evt_std_03", teamId: "study_c", teamName: "C팀 (Tableau & D3.js 대시보드)", name: "문지훈", term: 27, track: "시각화", status: "present", checkedInAt: "18:50" },
      { id: "att_st_c2", eventId: "evt_std_03", teamId: "study_c", teamName: "C팀 (Tableau & D3.js 대시보드)", name: "최민혁", term: 28, track: "시각화", status: "present", checkedInAt: "18:53" },
      { id: "att_st_c3", eventId: "evt_std_03", teamId: "study_c", teamName: "C팀 (Tableau & D3.js 대시보드)", name: "한예린", term: 28, track: "시각화", status: "present", checkedInAt: "18:56" },
      { id: "att_st_c4", eventId: "evt_std_03", teamId: "study_c", teamName: "C팀 (Tableau & D3.js 대시보드)", name: "윤재혁", term: 28, track: "시각화", status: "absent", checkedInAt: "-", memo: "교통 지연 결석" },

      { id: "att_st_d1", eventId: "evt_std_03", teamId: "study_d", teamName: "D팀 (LLM Agent & RAG 시스템)", name: "고준서", term: 27, track: "분석", status: "present", checkedInAt: "18:40" },
      { id: "att_st_d2", eventId: "evt_std_03", teamId: "study_d", teamName: "D팀 (LLM Agent & RAG 시스템)", name: "남소희", term: 27, track: "엔지니어링", status: "present", checkedInAt: "18:46" },
      { id: "att_st_d3", eventId: "evt_std_03", teamId: "study_d", teamName: "D팀 (LLM Agent & RAG 시스템)", name: "박지훈", term: 28, track: "분석", status: "present", checkedInAt: "18:51" },
      { id: "att_st_d4", eventId: "evt_std_03", teamId: "study_d", teamName: "D팀 (LLM Agent & RAG 시스템)", name: "장나연", term: 28, track: "시각화", status: "present", checkedInAt: "18:54" },
    ],
  },
  ADV: {
    ...
    teamLabel: "프로젝트 팀",
    teams: [
      { id: "adv_t1", track: "분석", name: "1팀 (LLM Agentic 워크플로우)", leader: "고준서", description: "LangGraph 기반 다중 에이전트 협업 시스템 구축", memberCount: 4 },
      { id: "adv_t2", track: "분석", name: "2팀 (시계열 예측 솔루션)", leader: "김서하", description: "금융 및 이상탐지 시계열 파운데이션 모델링", memberCount: 4 },
      { id: "adv_t3", track: "분석", name: "3팀 (금융 FDS 이상거래 탐지 AI)", leader: "박성준", description: "그래프 신경망 기반 금융 사기 및 이상 거래 실시간 탐지", memberCount: 4 },

      { id: "adv_t4", track: "시각화", name: "1팀 (인터랙티브 웹 시각화 대시보드)", leader: "최민혁", description: "Next.js & D3.js 기반 엔터프라이즈 데이터 시각화", memberCount: 4 },
      { id: "adv_t5", track: "시각화", name: "2팀 (지리공간 맵핑 & 인포그래픽)", leader: "문지훈", description: "Mapbox & Deck.gl 기반 공간 데이터 시각화", memberCount: 4 },
      { id: "adv_t6", track: "시각화", name: "3팀 (3D 바이오 메디컬 시각화)", leader: "한예린", description: "Three.js 기반 인체 장기 3D 렌더링 및 헬스케어 차트", memberCount: 4 },

      { id: "adv_t7", track: "엔지니어링", name: "1팀 (실시간 분산 스트리밍 추천)", leader: "강태양", description: "Kafka & Redis 기반 초개인화 실시간 추천 엔진", memberCount: 4 },
      { id: "adv_t8", track: "엔지니어링", name: "2팀 (멀티모달 헬스케어 AI 솔루션)", leader: "이도현", description: "의료 영상 및 EMR 텍스트 통합 분석 솔루션", memberCount: 4 },
      { id: "adv_t9", track: "엔지니어링", name: "3팀 (엔터프라이즈 RAG MLOps 파이프라인)", leader: "백민혁", description: "vLLM 및 Ray 기반 고성능 분산 서빙 인프라 구축", memberCount: 4 },
    ],
    initialEvents: [
      {
        id: "evt_adv_02",
    ...
    initialAttendees: [
      { id: "att_adv_1_1", eventId: "evt_adv_02", teamId: "adv_t1", teamName: "1팀 (LLM Agentic 워크플로우)", name: "고준서", term: 27, track: "분석", status: "present", checkedInAt: "13:20" },
      { id: "att_adv_1_2", eventId: "evt_adv_02", teamId: "adv_t1", teamName: "1팀 (LLM Agentic 워크플로우)", name: "김서하", term: 28, track: "분석", status: "present", checkedInAt: "13:25" },
      { id: "att_adv_1_3", eventId: "evt_adv_02", teamId: "adv_t1", teamName: "1팀 (LLM Agentic 워크플로우)", name: "이민준", term: 28, track: "분석", status: "present", checkedInAt: "13:28" },
      { id: "att_adv_1_4", eventId: "evt_adv_02", teamId: "adv_t1", teamName: "1팀 (LLM Agentic 워크플로우)", name: "정채원", term: 28, track: "분석", status: "present", checkedInAt: "13:30" },

      { id: "att_adv_2_1", eventId: "evt_adv_02", teamId: "adv_t2", teamName: "2팀 (시계열 예측 솔루션)", name: "박지훈", term: 28, track: "분석", status: "present", checkedInAt: "13:15" },
      { id: "att_adv_2_2", eventId: "evt_adv_02", teamId: "adv_t2", teamName: "2팀 (시계열 예측 솔루션)", name: "오승현", term: 28, track: "분석", status: "absent", checkedInAt: "-", memo: "사전 공결 승인" },
      { id: "att_adv_2_3", eventId: "evt_adv_02", teamId: "adv_t2", teamName: "2팀 (시계열 예측 솔루션)", name: "도현진", term: 27, track: "분석", status: "present", checkedInAt: "13:22" },
      { id: "att_adv_2_4", eventId: "evt_adv_02", teamId: "adv_t2", teamName: "2팀 (시계열 예측 솔루션)", name: "마지원", term: 28, track: "분석", status: "present", checkedInAt: "13:35" },

      { id: "att_adv_3_1", eventId: "evt_adv_02", teamId: "adv_t3", teamName: "3팀 (금융 FDS 이상거래 탐지 AI)", name: "박성준", term: 27, track: "분석", status: "present", checkedInAt: "13:18" },
      { id: "att_adv_3_2", eventId: "evt_adv_02", teamId: "adv_t3", teamName: "3팀 (금융 FDS 이상거래 탐지 AI)", name: "신유진", term: 28, track: "분석", status: "present", checkedInAt: "13:24" },
      { id: "att_adv_3_3", eventId: "evt_adv_02", teamId: "adv_t3", teamName: "3팀 (금융 FDS 이상거래 탐지 AI)", name: "안서연", term: 28, track: "분석", status: "present", checkedInAt: "13:29" },
      { id: "att_adv_3_4", eventId: "evt_adv_02", teamId: "adv_t3", teamName: "3팀 (금융 FDS 이상거래 탐지 AI)", name: "조민규", term: 28, track: "분석", status: "present", checkedInAt: "13:32" },

      { id: "att_adv_4_1", eventId: "evt_adv_02", teamId: "adv_t4", teamName: "1팀 (인터랙티브 웹 시각화 대시보드)", name: "최민혁", term: 28, track: "시각화", status: "present", checkedInAt: "13:20" },
      { id: "att_adv_4_2", eventId: "evt_adv_02", teamId: "adv_t4", teamName: "1팀 (인터랙티브 웹 시각화 대시보드)", name: "한예린", term: 28, track: "시각화", status: "present", checkedInAt: "13:24" },
      { id: "att_adv_4_3", eventId: "evt_adv_02", teamId: "adv_t4", teamName: "1팀 (인터랙티브 웹 시각화 대시보드)", name: "문지훈", term: 27, track: "시각화", status: "present", checkedInAt: "13:28" },
      { id: "att_adv_4_4", eventId: "evt_adv_02", teamId: "adv_t4", teamName: "1팀 (인터랙티브 웹 시각화 대시보드)", name: "장나연", term: 28, track: "시각화", status: "present", checkedInAt: "13:30" },

      { id: "att_adv_5_1", eventId: "evt_adv_02", teamId: "adv_t5", teamName: "2팀 (지리공간 맵핑 & 인포그래픽)", name: "윤재혁", term: 28, track: "시각화", status: "present", checkedInAt: "13:19" },
      { id: "att_adv_5_2", eventId: "evt_adv_02", teamId: "adv_t5", teamName: "2팀 (지리공간 맵핑 & 인포그래픽)", name: "송하늘", term: 27, track: "시각화", status: "present", checkedInAt: "13:23" },
      { id: "att_adv_5_3", eventId: "evt_adv_02", teamId: "adv_t5", teamName: "2팀 (지리공간 맵핑 & 인포그래픽)", name: "노유진", term: 27, track: "시각화", status: "present", checkedInAt: "13:27" },
      { id: "att_adv_5_4", eventId: "evt_adv_02", teamId: "adv_t5", teamName: "2팀 (지리공간 맵핑 & 인포그래픽)", name: "원승민", term: 28, track: "시각화", status: "absent", checkedInAt: "-", memo: "개인 사정 결석" },

      { id: "att_adv_6_1", eventId: "evt_adv_02", teamId: "adv_t6", teamName: "3팀 (3D 바이오 메디컬 시각화)", name: "배준호", term: 28, track: "시각화", status: "present", checkedInAt: "13:21" },
      { id: "att_adv_6_2", eventId: "evt_adv_02", teamId: "adv_t6", teamName: "3팀 (3D 바이오 메디컬 시각화)", name: "권나현", term: 28, track: "시각화", status: "present", checkedInAt: "13:25" },
      { id: "att_adv_6_3", eventId: "evt_adv_02", teamId: "adv_t6", teamName: "3팀 (3D 바이오 메디컬 시각화)", name: "서진우", term: 27, track: "시각화", status: "present", checkedInAt: "13:29" },
      { id: "att_adv_6_4", eventId: "evt_adv_02", teamId: "adv_t6", teamName: "3팀 (3D 바이오 메디컬 시각화)", name: "하예원", term: 28, track: "시각화", status: "present", checkedInAt: "13:33" },

      { id: "att_adv_7_1", eventId: "evt_adv_02", teamId: "adv_t7", teamName: "1팀 (실시간 분산 스트리밍 추천)", name: "강태양", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:15" },
      { id: "att_adv_7_2", eventId: "evt_adv_02", teamId: "adv_t7", teamName: "1팀 (실시간 분산 스트리밍 추천)", name: "이도현", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:18" },
      { id: "att_adv_7_3", eventId: "evt_adv_02", teamId: "adv_t7", teamName: "1팀 (실시간 분산 스트리밍 추천)", name: "임수진", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:22" },
      { id: "att_adv_7_4", eventId: "evt_adv_02", teamId: "adv_t7", teamName: "1팀 (실시간 분산 스트리밍 추천)", name: "남소희", term: 27, track: "엔지니어링", status: "absent", checkedInAt: "-", memo: "개인 일정 결석" },

      { id: "att_adv_8_1", eventId: "evt_adv_02", teamId: "adv_t8", teamName: "2팀 (멀티모달 헬스케어 AI 솔루션)", name: "박성훈", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:19" },
      { id: "att_adv_8_2", eventId: "evt_adv_02", teamId: "adv_t8", teamName: "2팀 (멀티모달 헬스케어 AI 솔루션)", name: "백민혁", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:23" },
      { id: "att_adv_8_3", eventId: "evt_adv_02", teamId: "adv_t8", teamName: "2팀 (멀티모달 헬스케어 AI 솔루션)", name: "류현우", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:27" },
      { id: "att_adv_8_4", eventId: "evt_adv_02", teamId: "adv_t8", teamName: "2팀 (멀티모달 헬스케어 AI 솔루션)", name: "조영준", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:31" },

      { id: "att_adv_9_1", eventId: "evt_adv_02", teamId: "adv_t9", teamName: "3팀 (엔터프라이즈 RAG MLOps 파이프라인)", name: "황지수", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:17" },
      { id: "att_adv_9_2", eventId: "evt_adv_02", teamId: "adv_t9", teamName: "3팀 (엔터프라이즈 RAG MLOps 파이프라인)", name: "김동현", term: 27, track: "엔지니어링", status: "present", checkedInAt: "13:21" },
      { id: "att_adv_9_3", eventId: "evt_adv_02", teamId: "adv_t9", teamName: "3팀 (엔터프라이즈 RAG MLOps 파이프라인)", name: "문가영", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:26" },
      { id: "att_adv_9_4", eventId: "evt_adv_02", teamId: "adv_t9", teamName: "3팀 (엔터프라이즈 RAG MLOps 파이프라인)", name: "유재성", term: 28, track: "엔지니어링", status: "present", checkedInAt: "13:34" },
    ],
  },
};

const ATTEND_STATUS_CFG: Record<AttendStatus, { label: string; code: string; color: string; bg: string; border: string }> = {
  ...
  excusedAbsent:   { label: "인정결석", code: "3", color: "#1e40af", bg: "#eff6ff", border: "#bfdbfe" },
  remote:          { label: "비대면", code: "ON", color: "#4338ca", bg: "#eef2ff", border: "#c7d2fe" },
  unexcusedLate:   { label: "무단지각", code: "4", color: "#c2410c", bg: "#fff7ed", border: "#fed7aa" },
  unexcusedAbsent: { label: "무단결석", code: "5", color: "#991b1b", bg: "#fee2e2", border: "#fca5a5" },
...
const ATTEND_STATUS_STYLES: Record<AttendStatus, { active: string; inactive: string }> = {
  ...
  remote: {
    ...
    inactive: "text-slate-400 hover:text-[#4338ca] hover:bg-white/60 border border-transparent font-medium",
  },
  unexcusedLate: {
...
export interface ExportColumnConfig {
  id: "term" | "name" | "week" | "absence" | "unexcusedAbsence" | "lateEarlyLeave" | "remote" | "totalScore" | "track" | "teamName" | "status" | "checkedInAt" | "memo";
  label: string;
  enabled: boolean;
}
...
export function InternalCategoryAttendancePage({ category, activeScoreRule }: InternalCategoryAttendancePageProps) {
      ...
      try {
        ...
        if (saved) {
          ...
          if (Array.isArray(parsed)) {
            ...
            if (active) setSyncedScoreRule(active);
          }
        }
      } catch {}
    };
  ...
  const currentScoreRule: ScoreRule = syncedScoreRule || activeScoreRule || (() => {
    try {
      const saved = localStorage.getItem("boaz_score_rules");
      if (saved) {
        const parsed = JSON.parse(saved);
  ...
  const [selectedTeamId, setSelectedTeamId] = useState<string>((category === "ADV" || category === "STUDY") ? "ALL" : (config.teams[0]?.id || ""));
  ...
  const [activeStudyEditCell, setActiveStudyEditCell] = useState<{ rowId: string; weekNum: number } | null>(null);

  // User interactive status & memo overrides keyed by: `${category}_${termPeriod}_${selectedWeek}_${attendeeId}`
  const [attendanceOverrides, setAttendanceOverrides] = useState<Record<string, { status: AttendStatus; memo?: string; checkedInAt?: string }>>({});
  ...
  const [sortOption, setSortOption] = useState<"DEFAULT" | "TERM_ASC" | "TERM_DESC" | "NAME_ASC">("TERM_ASC");

  const availableTerms = useMemo(() => {
    const set = new Set<number>();
    attendees.forEach(a => {
      if (a.term) set.add(a.term);
    });
    return Array.from(set).sort((a, b) => b - a);
  }, [attendees]);

  // Settings: Committed/Saved State vs Modal Draft State
  const [savedWeekDateMapping, setSavedWeekDateMapping] = useState<Record<number, string>>(DEFAULT_WEEK_DATE_MAPPING);
  const [savedExportColumns, setSavedExportColumns] = useState<ExportColumnConfig[]>(DEFAULT_EXPORT_COLUMNS);
  const [savedCustomColOrder, setSavedCustomColOrder] = useState<string[] | null>(null);

  const [weekDateMapping, setWeekDateMapping] = useState<Record<number, string>>(DEFAULT_WEEK_DATE_MAPPING);
  ...
  const handleMoveColumn = (index: number, direction: "up" | "down") => {
    ...
    if (targetIndex < 0 || targetIndex >= exportColumns.length) return;
  ...
  const handleToggleColumn = (id: string) => {
    setExportColumns(prev => prev.map(col => col.id === id ? { ...col, enabled: !col.enabled } : col));
  };

  const handleRenameColumn = (id: string, newLabel: string) => {
    setExportColumns(prev => prev.map(col => col.id === id ? { ...col, label: newLabel } : col));
  };

  const handleAutoGenerateDates = () => {
    if (!startDateGenerator) return;
    const baseDate = new Date(startDateGenerator);
    const updated = { ...weekDateMapping };
    const targetWeeks = termPeriod === "VACATION" ? VACATION_WEEKS_8 : SEMESTER_WEEKS_8;

    targetWeeks.forEach((w, idx) => {
      const d = new Date(baseDate);
      d.setDate(baseDate.getDate() + idx * 7);
      const mm = String(d.getMonth() + 1).padStart(2, "0");
      const dd = String(d.getDate()).padStart(2, "0");
      updated[w.weekNum] = `${mm}/${dd}`;
    });

    setWeekDateMapping(updated);
    alert(`✅ ${termPeriod === "VACATION" ? "방학(1~8주차)" : "학기(9~16주차)"} 시작일(${startDateGenerator}) 기준으로 7일 간격 날짜 매핑이 자동 생성되었습니다!`);
  };
  ...
  const [newMemberTrack, setNewMemberTrack] = useState("분석");
  ...
  useEffect(() => {
    ...
    setSelectedTeamId((category === "ADV" || category === "STUDY") ? "ALL" : (config.teams[0]?.id || ""));
  ...
  const selectedTeam: TeamMeta = isAllSelected
    ...
    : (config.teams.find(t => t.id === selectedTeamId) || config.teams[0] || {
        id: "",
        name: "선택된 팀",
        leader: "",
        description: "",
  ...
  const activeSubmittedWeeks = termPeriod === "VACATION"
    ? VACATION_WEEKS_8.filter(w => w.weekNum <= 3)
    : SEMESTER_WEEKS_8.filter(w => w.weekNum <= 11);

  const currentTeamAttendees: InternalAttendee[] = (selectedWeek === 0
        ...
        baseAttendees.map(a => {
          ...
          if (override && override.status) {
            return {
              ...
              checkedInAt: override.checkedInAt || (override.status === "present" || override.status === "late" ? "14:00" : "-"),
          ...
          if (termPeriod === "VACATION") {
            const isAbsentThisWeek =
              (a.name === "오승현" && (currentWeekNum === 2 || currentWeekNum === 3 || currentWeekNum === 7)) ||
              (a.name === "원승민" && (currentWeekNum === 3 || currentWeekNum === 5)) ||
              (a.name === "남소희" && (currentWeekNum === 3 || currentWeekNum === 6));

            const isLateThisWeek =
              category === "SESSION" &&
              ((a.name === "장나연" && currentWeekNum === 3) || (a.name === "문지훈" && currentWeekNum === 2));
            ...
            return {
              ...
              weekLabel: w.label,
              status,
              checkedInAt: status === "present" || status === "late" ? (status === "late" ? "14:15" : "13:50") : "-",
              memo: isAbsentThisWeek ? "방학 개인 사정 (사전 공결 신청 승인)" : (status === "late" ? "15분 지각" : (a.memo || "")),
            };
          } else {
            const isAbsentThisWeek =
            ...
            return {
              ...
              status,
              checkedInAt: status === "present" || status === "late" ? (status === "late" ? "14:15" : "13:50") : "-",
              memo: isAbsentThisWeek ? "학기 과제/시험 일정 결석" : (status === "late" ? "수업 종료 후 15분 지각" : (a.memo || "")),
            };
          }
        })
      )
    : baseAttendees.map(a => {
        ...
        if (termPeriod === "VACATION") {
          const isAbsentThisWeek =
            (a.name === "오승현" && (selectedWeek === 2 || selectedWeek === 3 || selectedWeek === 7)) ||
            (a.name === "원승민" && (selectedWeek === 3 || selectedWeek === 5)) ||
            (a.name === "남소희" && (selectedWeek === 3 || selectedWeek === 6));

          const isLateThisWeek =
            category === "SESSION" &&
            ((a.name === "장나연" && selectedWeek === 3) || (a.name === "문지훈" && selectedWeek === 2));
  ...
  const filteredAttendees = useMemo(() => {
    let list = currentTeamAttendees.filter(a => {
      if (selectedTrackFilter !== "ALL") {
        ...
        if (!matchesTrack(a.track || "")) return false;
      }
      if (termFilter !== "ALL") {
        if (`${a.term}` !== termFilter) return false;
      }
      ...
      if (attendeeSearch.trim()) {
        ...
        if (!matchName && !matchMemo && !matchTrack && !matchTeam) return false;
      }
      return true;
    });

    if (sortOption === "TERM_ASC") {
      list = [...list].sort((a, b) => (a.term || 0) - (b.term || 0) || a.name.localeCompare(b.name, "ko"));
    } else if (sortOption === "TERM_DESC") {
      list = [...list].sort((a, b) => (b.term || 0) - (a.term || 0) || a.name.localeCompare(b.name, "ko"));
    } else if (sortOption === "NAME_ASC") {
      list = [...list].sort((a, b) => a.name.localeCompare(b.name, "ko"));
    }

    return list;
  }, [currentTeamAttendees, selectedTrackFilter, termFilter, attendStatusFilter, attendeeSearch, sortOption]);

  // ADV Overall Matrix Rows calculation & BASE Term (전체 주차) Matrix calculation
  const isMatrixMode = (category === "ADV" && isAllSelected) || (category === "SESSION" && selectedWeek === 0);
  ...
  const matrixTableMinWidth = useMemo(() => {
    let sum = (colWidths.matrix_index || 42) +
    ...
    if (selectedWeek === 0) {
      sum += (colWidths.matrix_absence || 60) +
    ...
    return Math.max(sum, selectedWeek === 0 ? (selectedTrackFilter === "ALL" ? 850 : 750) : (selectedTrackFilter === "ALL" ? 500 : 440));
  }, [category, colWidths, displayedMatrixWeeks, selectedWeek, selectedTrackFilter, termPeriod]);

  // 단일 팀 표 최소 너비 계산
  const singleTeamTableMinWidth = useMemo(() => {
    const isSingleTeamEditable = category === "SESSION" || (category === "ADV" && isWeekDirectEditable(selectedWeek) && selectedWeek !== 0);
    const statusMinWidth = isSingleTeamEditable ? 385 : 70;
    const statusEffectiveWidth = Math.max(colWidths.status || (isSingleTeamEditable ? 390 : 70), statusMinWidth);

    let sum = (colWidths.name || 70) + (colWidths.term || 50) + statusEffectiveWidth + (colWidths.memo || 240);
    if (selectedWeek === 0) sum += (colWidths.week || 60);
    if (category !== "SESSION" && isAllSelected) sum += (colWidths.track || 60);
    if (isAllSelected && category !== "SESSION") sum += (colWidths.teamName || 90);
    if (category !== "SESSION" && !isAllSelected) sum += (colWidths.track || 60);
    if (isTableEditMode) sum += 40;
  ...
  const studyAllTableMinWidth = useMemo(() => {
    let sum = (colWidths.study_all_index || 42) +
  ...
  const studyTeamTableMinWidth = useMemo(() => {
    let sum = (colWidths.study_team_index || 42) +
  ...
  const matrixRows = useMemo(() => {
    return distinctMembers.map(member => {
      const weekData: Record<number, { status: AttendStatus; memo?: string; checkedInAt?: string }> = {};
      let absenceCount = 0;
      ...
      currentTermWeeks.forEach(w => {
        ...
        if (override && override.status) {
          ...
          if (termPeriod === "VACATION") {
            if (currentWeekNum > 3 && category !== "SESSION") {
              ...
              const isAbsentThisWeek =
                (member.name === "오승현" && (currentWeekNum === 2 || currentWeekNum === 3 || currentWeekNum === 7)) ||
                (member.name === "원승민" && (currentWeekNum === 3 || currentWeekNum === 5)) ||
                (member.name === "남소희" && (currentWeekNum === 3 || currentWeekNum === 6));
              const isLateThisWeek =
                category === "SESSION" &&
                ((member.name === "장나연" && currentWeekNum === 3) || (member.name === "문지훈" && currentWeekNum === 2));
        ...
        else if (status === "unexcusedAbsent") unexcusedAbsenceCount++;
        else if (status === "late" || status === "earlyLeave" || status === "unexcusedLate") lateEarlyLeaveCount++;
        else if (status === "remote" || (memo?.includes("비대면") ?? false) || (memo?.includes("온라인") ?? false)) remoteCount++;
      });
      ...
      if (category === "STUDY") {
        currentTermWeeks.forEach(w => {
          if (weekData[w.weekNum]?.status === "present") attendedCount++;
        });
        const isLeader = config.teams.some(t => t.id === member.teamId && t.leader === member.name);
        ...
        const baseScore = attendedCount <= 4 ? failPenalty : attendedCount < 7 ? passBonus : perfectBonus;
        ...
        totalScore = (absenceCount * absentPenalty) + (unexcusedAbsenceCount * unexcusedAbsentPenalty) + (lateEarlyLeaveCount * latePenalty);
      }
  ...
  }, [category, termPeriod, distinctMembers, currentTermWeeks, attendanceOverrides, currentScoreRule, config.teams]);
  ...
  const filteredMatrixRows = useMemo(() => {
    let rows = matrixRows.filter(row => {
      if (category !== "STUDY" && selectedTrackFilter !== "ALL") {
        ...
        if (!matchesTrack(row.track || "")) return false;
      }
      if (termFilter !== "ALL") {
        if (`${row.term}` !== termFilter) return false;
      }
      if (attendeeSearch.trim()) {
        const q = attendeeSearch.toLowerCase();
        const match =
      ...
      if (attendStatusFilter !== "ALL") {
        const hasStatus = displayedMatrixWeeks.some(w => row.weekData[w.weekNum]?.status === attendStatusFilter);
    ...
    if (category === "STUDY") {
      if (studySortMode === "TEAM") {
        ...
        rows = [...rows].sort((a, b) => {
          if ((a.term || 0) !== (b.term || 0)) return (a.term || 0) - (b.term || 0);
          return a.name.localeCompare(b.name, "ko");
        });
      }
    } else {
      if (sortOption === "TERM_ASC") {
        rows = [...rows].sort((a, b) => (a.term || 0) - (b.term || 0) || a.name.localeCompare(b.name, "ko"));
      } else if (sortOption === "TERM_DESC") {
        rows = [...rows].sort((a, b) => (b.term || 0) - (a.term || 0) || a.name.localeCompare(b.name, "ko"));
      } else if (sortOption === "NAME_ASC") {
    ...
    return rows;
  }, [category, matrixRows, config.teams, studySortMode, selectedTrackFilter, termFilter, attendeeSearch, attendStatusFilter, displayedMatrixWeeks, sortOption]);

  const studyTeamRows = useMemo(() => {
    if (category !== "STUDY") return [];
    if (isAllSelected) return filteredMatrixRows;
  ...
  const totalCount = currentTeamAttendees.length;
  const presentCount = currentTeamAttendees.filter(a => a.status === "present").length;
  const lateCount = currentTeamAttendees.filter(a => a.status === "late" || a.status === "earlyLeave").length;
  const absentCount = currentTeamAttendees.filter(a => a.status === "absent").length;
  const unmarkedCount = currentTeamAttendees.filter(a => a.status === "unmarked").length;
  ...
  function handleStatusChange(attendeeId: string, newStatus: AttendStatus, targetWeekNum?: number) {
    ...
    const targetWeek = targetWeekNum || (selectedWeek === 0 ? (termPeriod === "VACATION" ? 3 : 11) : selectedWeek);
    ...
    setAttendanceOverrides(prev => ({
      ...
      [key]: {
        ...prev[key],
        status: newStatus,
        checkedInAt: (newStatus === "present" || newStatus === "late" || newStatus === "earlyLeave" || newStatus === "unexcusedLate") ? nowTime : "-",
      },
    }));
  }
  ...
  function handleDeleteAttendee(attendeeId: string) {
    if (!window.confirm("정말 이 부원을 명단에서 제외하시겠습니까?")) return;
  ...
  function handleAddMemberToRoster() {
    ...
    const newId = `att_user_${Date.now()}`;
    const newRecord: InternalAttendee = {
      id: newId,
  ...
  function handleUploadEventImage(e: React.ChangeEvent<HTMLInputElement>) {
    const file = e.target.files?.[0];
    if (!file) return;
    const reader = new FileReader();
    reader.onload = () => {
      const result = reader.result as string;
      setEvents(prev => prev.map(evt => evt.id === selectedEvent.id ? { ...evt, imageUrl: result } : evt));
    };
      ...
      if (!isAllSelected) {
        ...
        const cols: ModalColItem[] = [
          {
            id: "term",
            label: "기수",
            renderCell: row => <span className="font-mono text-slate-600 text-xs px-3 whitespace-nowrap">{row?.term ?? 28}기</span>,
            exportValue: row => `${row?.term ?? 28}기`,
          },
          {
            id: "name",
            label: "이름",
            renderCell: row => <span className="font-bold text-slate-900 text-xs px-4 whitespace-nowrap">{row?.name ?? ""}</span>,
            exportValue: row => row?.name ?? "",
          },
          ...displayedMatrixWeeks.map(w => {
            const rawDate = (weekDateMapping[w.weekNum] || savedWeekDateMapping[w.weekNum] || "")?.trim();
          ...
          }),
          {
            id: "attendedCount",
            label: "참여 횟수",
            renderCell: row => <span className="font-mono text-xs text-slate-800 font-bold whitespace-nowrap">{row?.attendedCount ?? 0}회</span>,
          ...
          },
          {
            ...
            renderCell: row => {
              ...
              return (
                <span className={`text-xs font-bold font-mono whitespace-nowrap ${isLeader ? "text-slate-900" : "text-slate-300 font-normal"}`}>
                  {isLeader ? "1" : "-"}
                </span>
              );
            },
            ...
            renderCell: row => {
              ...
              return (
                <span className={`font-bold font-mono whitespace-nowrap ${
                  score === 0 ? "text-slate-400 font-medium" :
                  score < 0 ? "text-rose-600" : "text-emerald-700"
                }`}>
                  {score}
                </span>
              );
        ...
        const cols: ModalColItem[] = [
          ...
          },
          {
            id: "track",
            label: "부문",
            renderCell: row => <span className="text-slate-600 text-xs px-3 whitespace-nowrap">{row?.track ?? ""}</span>,
          ...
          ...(config.teams || []).map(team => ({
            ...
            renderCell: (row: any) => {
              ...
              if (!isMember) return <span className="text-slate-300 whitespace-nowrap">-</span>;
              const sc = row?.totalScore ?? 0;
              return (
                <span className={`font-bold font-mono whitespace-nowrap ${
                  sc === 0 ? "text-slate-400 font-medium" :
                  sc < 0 ? "text-rose-600" : "text-emerald-700"
                }`}>
                  {sc}
                </span>
              );
      ...
      const cols: ModalColItem[] = [
        {
          id: "term",
          label: "기수",
          renderCell: row => <span className="font-mono text-slate-600 text-xs px-2 whitespace-nowrap">{row?.term ?? 28}기</span>,
          exportValue: row => `${row?.term ?? 28}기`,
        },
        {
          id: "name",
          label: "이름",
          renderCell: row => <span className="font-bold text-slate-900 text-xs px-3 whitespace-nowrap">{row?.name ?? ""}</span>,
          exportValue: row => row?.name ?? "",
        },
        {
          id: "track",
          label: "부문",
          renderCell: row => <span className="text-slate-600 text-xs px-2.5 whitespace-nowrap">{row?.track ?? ""}</span>,
          exportValue: row => row?.track ?? "",
        },
        ...displayedMatrixWeeks.map(w => {
          const rawDate = (weekDateMapping[w.weekNum] || savedWeekDateMapping[w.weekNum] || "")?.trim();
        ...
        }),
        {
          id: "absence",
          label: "결석",
          renderCell: row => <span className="font-mono text-xs whitespace-nowrap">{row?.absenceCount ?? 0}</span>,
          exportValue: row => String(row?.absenceCount ?? 0),
        },
        {
          id: "unexcusedAbsence",
          label: "무단결석",
          renderCell: row => <span className="font-mono text-xs whitespace-nowrap">{row?.unexcusedAbsenceCount ?? 0}</span>,
          exportValue: row => String(row?.unexcusedAbsenceCount ?? 0),
        },
        {
          id: "lateEarlyLeave",
          label: "지각조퇴",
          renderCell: row => <span className="font-mono text-xs whitespace-nowrap">{row?.lateEarlyLeaveCount ?? 0}</span>,
          exportValue: row => String(row?.lateEarlyLeaveCount ?? 0),
        },
        {
          id: "remote",
          label: "비대면 횟수",
          renderCell: row => <span className="font-mono text-xs whitespace-nowrap">{row?.remoteCount ?? 0}</span>,
  ...
  }, [category, isAllSelected, displayedMatrixWeeks, weekDateMapping, savedWeekDateMapping, studyTeamRows, filteredMatrixRows, selectedTeam, termPeriod, config.teams]);

  const activeModalCols = useMemo(() => {
    if (!customColOrder) return defaultModalCols;
  ...
  function handleExportCsv() {
    ...
    const csvContent = "\uFEFF" + [headers.join(","), ...exportData.map(row => row.map(c => `"${(c ?? "").replace(/"/g, '""')}"`).join(","))].join("\n");
  ...
  function handleUploadCsv(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = (event) => {
      ...
      // Parse header row
      const rawHeaderCols = lines[0].split(",").map(c => c.replace(/^["']|["']$/g, '').trim().toLowerCase());
      const hasHeader = rawHeaderCols.some(h => 
        h.includes("이름") || h.includes("성명") || h.includes("트랙") || h.includes("부문") || h.includes("팀") || h.includes("기수")
      );

      let nameIdx = rawHeaderCols.findIndex(h => h.includes("이름") || h.includes("성명") || h.includes("부원") || h === "name");
      let trackIdx = rawHeaderCols.findIndex(h => h.includes("트랙") || h.includes("부문") || h.includes("분야") || h === "track");
      let teamIdx = rawHeaderCols.findIndex(h => h.includes("팀") || h.includes("소속") || h === "team");
      let termIdx = rawHeaderCols.findIndex(h => h.includes("기수") || h.includes("기") || h === "term");
      let statusIdx = rawHeaderCols.findIndex(h => h.includes("출결") || h.includes("상태") || h.includes("출석") || h === "status");
      let memoIdx = rawHeaderCols.findIndex(h => h.includes("비고") || h.includes("메모") || h.includes("사유") || h === "memo");
      ...
      dataRows.forEach((row, idx) => {
        ...
        const normalizedTrack =
          trackRaw.includes("분석") ? "분석" :
          trackRaw.includes("시각") ? "시각화" :
          trackRaw.includes("엔지") ? "엔지니어링" :
        ...
        let matchedTeam = config.teams.find(t => {
          if (t.track && t.track !== normalizedTrack) return false;
          if (t.id.toLowerCase() === teamRaw.toLowerCase()) return true;

          const cleanTeamName = t.name.replace(/\s+/g, "");
          const cleanTeamRaw = teamRaw.replace(/\s+/g, "");
          if (cleanTeamName && cleanTeamRaw && (cleanTeamName.includes(cleanTeamRaw) || cleanTeamRaw.includes(cleanTeamName))) {
            return true;
          }
        ...
        if (!matchedTeam) {
          matchedTeam = config.teams.find(t => t.track === normalizedTrack) || config.teams[0] || selectedTeam;
        }

        // 3. Determine status
        const stLower = statusRaw.toLowerCase();
        const status: AttendStatus =
          stLower.includes("지각") || stLower === "late" ? (category === "SESSION" ? "late" : "present") :
          stLower.includes("결석") || stLower === "absent" ? "absent" : "present";
      ...
      if (newAttendeesList.length > 0) {
        if (isAllSelected) {
          ...
          setAttendees(prev => [
            ...newAttendeesList,
            ...prev.filter(a => !(a.eventId === selectedEvent.id && a.teamId === selectedTeam.id)),
          ]);
        }
  ...
  return (
    <div className="flex flex-col flex-1 h-full min-h-0 space-y-3 w-full" style={{ fontFamily: "'Pretendard Variable', Pretendard, -apple-system, BlinkMacSystemFont, system-ui, sans-serif" }}>
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-between gap-2.5 pt-1.5 pb-1 px-0.5">
              ...
              <div className="flex items-center gap-2">
                ...
                {!isAllSelected && selectedWeek === 0 && (category === "ADV" || category === "STUDY") && (
                  <button
                    type="button"
              ...
              <div ref={tableContainerRef} className="overflow-x-auto select-none relative">
                {category === "STUDY" ? (
                  isAllSelected ? (
                    ...
                    <table className="w-full text-xs table-fixed border-collapse" style={{ minWidth: `${studyAllTableMinWidth}px` }}>
                      <thead className="bg-slate-50/80 select-none">
                        <tr className="border-b border-slate-200 divide-x divide-slate-200 text-slate-700 font-semibold text-[11px] whitespace-nowrap h-11">
                          <th style={{ width: `${colWidths.study_all_index || 42}px` }} className="relative text-center px-1 py-1 text-slate-500 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">#</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_all_index", 35)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_all_index"); updateGuidelinePos(e.currentTarget); } }}
                          ...
                          <th style={{ width: `${colWidths.study_all_term || 55}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">기수</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_all_term", 45)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_all_term"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_all_track || 65}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">부문</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_all_track", 55)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_all_track"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_all_name || 80}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">이름</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_all_name", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_all_name"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          ...
                          {config.teams.map(team => {
                            ...
                            const defaultWidth = 160;
                            const minWidth = 100;
                            const effectiveWidth = Math.max(colWidths[colKey] || defaultWidth, minWidth);
                            ...
                            return (
                              ...
                              >
                                <div className="h-9 flex flex-col items-center justify-center px-1">
                                  <span className="font-bold text-xs truncate max-w-full" title={team.name}>
                                    {team.name}
                                  </span>
                                </div>
                                <div
                          ...
                          >
                            ...
                            <div
                              ...
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_all_score"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                      ...
                      <tbody className="divide-y divide-slate-100 font-mono">
                        {filteredMatrixRows.length === 0 ? (
                          <tr>
                            <td colSpan={5 + config.teams.length} className="py-12 text-center text-slate-400 space-y-1 font-sans">
                              <Users size={28} className="mx-auto text-slate-300 mb-1" />
                              <p className="font-bold text-slate-700 text-xs">해당 조건의 인원이 없습니다.</p>
                            </td>
                          </tr>
                        ) : (
                          filteredMatrixRows.map((row, idx) => (
                            <tr key={row.id} className="hover:bg-slate-50/70 transition-colors divide-x divide-slate-200 h-[46px]">
                              ...
                              <td className="relative px-1.5 py-1.5 text-center text-slate-600 text-xs">
                                <div className="h-8 flex items-center justify-center">{row.term}기</div>
                              </td>
                              <td className="relative px-2 py-1.5 text-center text-slate-600 text-xs font-sans font-medium">
                                <div className="h-8 flex items-center justify-center">{row.track}</div>
                              </td>
                              <td className="relative px-2 py-1.5 text-center font-bold text-slate-900 text-xs font-sans">
                                <div className="h-8 flex items-center justify-center">{row.name}</div>
                              </td>
                              {config.teams.map(team => {
                                const isMember = row.teamId === team.id;
                                    ...
                                    <div className="h-8 flex items-center justify-center">
                                      {isMember ? (
                                        <span className={`text-xs font-bold ${
                                          ...
                                          {row.totalScore > 0 ? `+${row.totalScore}점` : `${row.totalScore}점`}
                                        </span>
                                      ) : (
                    ...
                    <table className="w-full text-xs table-fixed border-collapse" style={{ minWidth: `${studyTeamTableMinWidth}px` }}>
                      <thead className="bg-slate-50/80 select-none">
                        <tr className="border-b border-slate-200 divide-x divide-slate-200 text-slate-700 font-semibold text-[11px] whitespace-nowrap h-11">
                          <th style={{ width: `${colWidths.study_team_index || 42}px` }} className="relative text-center px-1 py-1 text-slate-500 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">#</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_index", 35)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_index"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_team_term || 55}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">기수</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_term", 45)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_term"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_team_name || 80}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">이름</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_name", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_name"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          ...
                          {displayedMatrixWeeks.map(w => {
                            ...
                            const minColWidth = 55;
                            const defaultColWidth = 72;
                            const effectiveColWidth = Math.max(colWidths[colKey] || defaultColWidth, minColWidth);
                            return (
                              <th
                                key={w.id}
                              ...
                              >
                                <div className="h-9 flex flex-col items-center justify-center">
                                  {hasDate ? (
                                    <>
                                      <div className="font-mono font-bold text-slate-900 text-xs leading-none">{rawDate}</div>
                                      <div className="text-[10px] text-slate-400 font-normal leading-tight mt-0.5">{w.label}</div>
                                    </>
                                  ) : (
                                    <div className="font-bold text-slate-900 text-xs leading-none">{w.label}</div>
                                  )}
                                </div>
                                <div
                          ...
                          <th style={{ width: `${colWidths.study_team_attended || 85}px` }} className="relative text-center px-2 py-1 text-slate-700 font-semibold bg-slate-50/80">
                            <div className="h-9 flex items-center justify-center">참여 횟수</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_attended", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_attended"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_team_leader || 85}px` }} className="relative text-center px-2 py-1 text-slate-700 font-semibold bg-slate-50/80">
                            <div className="h-9 flex items-center justify-center">스터디장</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_leader", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_leader"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                          </th>
                          <th style={{ width: `${colWidths.study_team_score || 80}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">점수</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "study_team_score", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("study_team_score"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute right-0 top-0 bottom-0 w-3 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                      ...
                      <tbody className="divide-y divide-slate-100 font-mono">
                        {studyTeamRows.length === 0 ? (
                          <tr>
                            <td colSpan={3 + displayedMatrixWeeks.length + 3} className="py-12 text-center text-slate-400 space-y-1 font-sans">
                              <Users size={28} className="mx-auto text-slate-300 mb-1" />
                              <p className="font-bold text-slate-700 text-xs">해당 스터디 팀에 등록된 인원이 없습니다.</p>
                            </td>
                          </tr>
                        ) : (
                          studyTeamRows.map((row, idx) => {
                            const isLeader = row.name === selectedTeam?.leader;
                            const attendedCount = currentTermWeeks.filter(w => row.weekData[w.weekNum]?.status === "present").length;
                            const effectiveScore = (() => {
                              if (selectedWeek === 0) return row.totalScore;
                              const currentStatus = row.weekData[selectedWeek]?.status;
                              if (currentStatus === "absent") return (currentScoreRule.absentPenalty ?? -3);
                              if (currentStatus === "unexcusedAbsent") return (currentScoreRule.unexcusedAbsentPenalty ?? -4);
                              if (currentStatus === "late" || currentStatus === "earlyLeave" || currentStatus === "unexcusedLate") {
                            ...
                            return (
                              <tr key={row.id} className="hover:bg-slate-50/70 transition-colors divide-x divide-slate-200 h-[46px]">
                                    ...
                                    >
                                      <div className="h-8 flex items-center justify-center w-full">
                                        {isTableEditMode && st !== "unmarked" ? (() => {
                                          const isOpen = activeStudyEditCell?.rowId === row.id && activeStudyEditCell?.weekNum === w.weekNum;
                                          const isRightEdge = w.weekNum >= 7;
                                          const isLastRow = idx >= studyTeamRows.length - 1;
                                          const isFirstRow = idx === 0;
                                          const vAlignClass = isLastRow ? "bottom-0" : isFirstRow ? "top-0" : "top-1/2 -translate-y-1/2";

                                          return (
                                            <div className="relative flex items-center justify-center">
                                              <button
                                                type="button"
                                                onClick={() => setActiveStudyEditCell(isOpen ? null : { rowId: row.id, weekNum: w.weekNum })}
                                              ...
                                              >
                                                <span className={st === "present" ? "text-emerald-700" : "text-rose-600"}>
                                                  {st === "present" ? "출석" : "결석"}
                                                </span>
                                                <ChevronRight size={10} className={`text-slate-400 transition-transform duration-150 ${isOpen ? "text-blue-600" : ""}`} />
                                              </button>
                                              ...
                                              {isOpen && (
                                                <>
                                                  ...
                                                  <div className={`absolute ${isRightEdge ? "right-full mr-1" : "left-full ml-1"} ${vAlignClass} w-[78px] bg-white rounded-lg shadow-lg border border-slate-200 p-0.5 z-50 animate-in fade-in zoom-in-95 duration-100 font-sans`}>
                                                    <div className="space-y-0.5">
                                                      <button
                                                        type="button"
                                                        onClick={() => {
                                                          handleStatusChange(row.id, "present", w.weekNum);
                                                      ...
                                                      >
                                                        <span>출석</span>
                                                        {st === "present" && <Check size={11} className="text-emerald-600 stroke-[2.5]" />}
                                                      </button>

                                                      <button
                                                        type="button"
                                                        onClick={() => {
                                                          handleStatusChange(row.id, "absent", w.weekNum);
                                                          setActiveStudyEditCell(null);
                                                        }}
                                                        className={`w-full flex items-center justify-between px-2 py-1 rounded-md text-[11px] transition-colors cursor-pointer ${
                                                          st === "absent"
                                                      ...
                                                      >
                                                        <span>결석</span>
                                                        {st === "absent" && <Check size={11} className="text-rose-600 stroke-[2.5]" />}
                                                      </button>
                                                    </div>
                                                  </div>
                                                </>
                                ...
                                <td className="relative px-2 py-1.5 text-center text-xs font-sans font-bold text-slate-800">
                                  <div className="h-8 flex items-center justify-center font-mono">{attendedCount}회</div>
                                </td>
                                ...
                                <td className="relative text-center px-1.5 py-1.5 font-mono bg-slate-50/60">
                                  <div className="h-8 flex items-center justify-center">
                                    <span className={`text-xs font-bold ${
                                      effectiveScore === 0 ? "text-slate-400 font-medium" : effectiveScore < 0 ? "text-rose-600 font-bold" : "text-emerald-700 font-bold"
                                    }`}>
                                      {effectiveScore > 0 ? `+${effectiveScore}점` : `${effectiveScore}점`}
                                    </span>
                                  </div>
                                </td>
                              </tr>
                  ...
                  <table className="w-full text-xs table-fixed border-collapse" style={{ minWidth: `${matrixTableMinWidth}px` }}>
                    <thead className="bg-slate-50/80 select-none">
                      <tr className="border-b border-slate-200 divide-x divide-slate-200 text-slate-700 font-semibold text-[11px] whitespace-nowrap h-11">
                        <th style={{ width: `${colWidths.matrix_index || 42}px` }} className="relative text-center px-1 py-1 text-slate-500 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">#</div>
                          <div
                            onMouseDown={e => handleResizeStart(e, "matrix_index", 35)}
                            onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_index"); updateGuidelinePos(e.currentTarget); } }}
                            onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                            className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                            title="열 너비 조절"
                          />
                        </th>
                        <th style={{ width: `${colWidths.matrix_term || 52}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">기수</div>
                          <div
                            onMouseDown={e => handleResizeStart(e, "matrix_term", 45)}
                            onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_term"); updateGuidelinePos(e.currentTarget); } }}
                            onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                            className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                            title="열 너비 조절"
                          />
                        </th>
                        <th style={{ width: `${colWidths.matrix_name || 80}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">이름</div>
                          <div
                            onMouseDown={e => handleResizeStart(e, "matrix_name", 60)}
                            onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_name"); updateGuidelinePos(e.currentTarget); } }}
                            onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                            className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                            title="열 너비 조절"
                          />
                        ...
                        {category !== "SESSION" && selectedTrackFilter === "ALL" && (
                          <th style={{ width: `${colWidths.matrix_track || 65}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">부문</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "matrix_track", 50)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_track"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                        ...
                        {selectedWeek === 0 && (
                          <>
                            <th style={{ width: `${colWidths.matrix_absence || 60}px` }} className="relative text-center px-2 py-1 text-slate-800 font-bold bg-pink-100/90">
                              <div className="h-9 flex items-center justify-center">결석</div>
                              <div
                                onMouseDown={e => handleResizeStart(e, "matrix_absence", 45)}
                                onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_absence"); updateGuidelinePos(e.currentTarget); } }}
                                onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                                className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                                title="열 너비 조절"
                              />
                            </th>
                            <th style={{ width: `${colWidths.matrix_unexcusedAbsence || 68}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-red-200/90">
                              <div className="h-9 flex items-center justify-center">무단결석</div>
                              <div
                                onMouseDown={e => handleResizeStart(e, "matrix_unexcusedAbsence", 50)}
                                onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_unexcusedAbsence"); updateGuidelinePos(e.currentTarget); } }}
                                onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                                className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                                title="열 너비 조절"
                              />
                            </th>
                            <th style={{ width: `${colWidths.matrix_late || 68}px` }} className="relative text-center px-2 py-1 text-slate-800 font-bold bg-amber-100">
                              <div className="h-9 flex items-center justify-center">지각조퇴</div>
                              <div
                                onMouseDown={e => handleResizeStart(e, "matrix_late", 50)}
                                onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_late"); updateGuidelinePos(e.currentTarget); } }}
                                onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                                className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                                title="열 너비 조절"
                              />
                            ...
                            {category === "ADV" && (
                              <th style={{ width: `${colWidths.matrix_remote || 75}px` }} className="relative text-center px-2 py-1 text-slate-800 font-bold bg-indigo-100">
                                <div className="h-9 flex items-center justify-center">비대면 횟수</div>
                                <div
                                  onMouseDown={e => handleResizeStart(e, "matrix_remote", 55)}
                                  onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_remote"); updateGuidelinePos(e.currentTarget); } }}
                                  onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                                  className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                                  title="열 너비 조절"
                                />
                        ...
                        <th style={{ width: `${colWidths.matrix_total || 75}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">
                            {selectedWeek === 0 ? "총점" : "점수"}
                          </div>
                          <div
                            onMouseDown={e => handleResizeStart(e, "matrix_total", 55)}
                            onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("matrix_total"); updateGuidelinePos(e.currentTarget); } }}
                            onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                            className="absolute right-0 top-0 bottom-0 w-3 cursor-col-resize select-none touch-none z-20"
                            title="열 너비 조절"
                          />
                    ...
                    <tbody className="divide-y divide-slate-100 font-mono">
                      {filteredMatrixRows.length === 0 ? (
                        <tr>
                          <td colSpan={(category !== "SESSION" && selectedTrackFilter === "ALL" ? 4 : 3) + displayedMatrixWeeks.length + (selectedWeek === 0 ? (category === "ADV" ? 4 : 3) : 0) + 1} className="py-12 text-center text-slate-400 space-y-1 font-sans">
                            <Users size={28} className="mx-auto text-slate-300 mb-1" />
                            <p className="font-bold text-slate-700 text-xs">해당 조건의 인원이 없습니다.</p>
                          </td>
                        </tr>
                        ...
                        filteredMatrixRows.map((row, idx) => {
                          ...
                          return (
                            <tr key={row.id} className="hover:bg-slate-50/70 transition-colors divide-x divide-slate-200 h-[46px]">
                              ...
                              {displayedMatrixWeeks.map(w => {
                                const isEditableDirect = isWeekDirectEditable(w.weekNum) && selectedWeek !== 0;
                                const cell = row.weekData[w.weekNum];
                                const st = cell?.status || "unmarked";
                                const cfg = ATTEND_STATUS_CFG[st] || ATTEND_STATUS_CFG.unmarked;
                                const rawDate = savedWeekDateMapping[w.weekNum]?.trim();
                                          ...
                                          {availableStatuses.map(s => {
                                            ...
                                            return (
                                              <button
                                                key={s}
                                                type="button"
                                                onClick={() => handleStatusChange(row.id, s, w.weekNum)}
                                                className={`py-1 text-[10px] sm:text-[11px] font-medium rounded transition-all cursor-pointer text-center whitespace-nowrap px-0.5 ${
                                                  active ? ATTEND_STATUS_STYLES[s].active : ATTEND_STATUS_STYLES[s].inactive
                                                }`}
                                              >
                                    ...
                                    <div className="h-8 flex items-center justify-center w-full">
                                      {isTableEditMode ? (
                                        <div className="relative w-[66px] h-[30px] flex items-center justify-center">
                                          <select
                                            value={st}
                                            onChange={e => handleStatusChange(row.id, e.target.value as AttendStatus, w.weekNum)}
                                          ...
                                          <ChevronDown size={11} className="absolute right-1.5 top-1/2 -translate-y-1/2 pointer-events-none text-slate-400" />
                                        </div>
                                      ) : (
                                        <div className="relative w-[66px] h-[30px] flex items-center justify-center">
                                          <span
                  ...
                  <table className="w-full text-xs table-fixed border-collapse" style={{ minWidth: `${singleTeamTableMinWidth}px` }}>
                    <thead className="bg-slate-50/80 select-none">
                      <tr className="border-b border-slate-200 divide-x divide-slate-200 text-slate-700 font-semibold text-[11px] whitespace-nowrap h-11">
                        {selectedWeek === 0 && (
                          <th style={{ width: `${colWidths.week}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">주차</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "week", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("week"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                        ...
                        {category !== "SESSION" && isAllSelected && selectedTrackFilter === "ALL" && (
                          <th style={{ width: `${colWidths.track}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">부문</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "track", 60)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("track"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                        ...
                        {isAllSelected && category !== "SESSION" && (
                          <th style={{ width: `${colWidths.teamName}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                            <div className="h-9 flex items-center justify-center">소속 팀</div>
                            <div
                              onMouseDown={e => handleResizeStart(e, "teamName", 90)}
                              onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("teamName"); updateGuidelinePos(e.currentTarget); } }}
                              onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                              className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                              title="열 너비 조절"
                            />
                        ...
                        <th style={{ width: `${colWidths.name}px` }} className="relative text-center px-2 py-1 text-slate-900 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">이름</div>
                          <div
                        ...
                        <th style={{ width: `${colWidths.term}px` }} className="relative text-center px-2 py-1 text-slate-700 font-bold bg-slate-100/90">
                          <div className="h-9 flex items-center justify-center">기수</div>
                          <div
                            onMouseDown={e => handleResizeStart(e, "term", 50)}
                            onMouseEnter={e => { if (!resizingColKey) { setActiveHoverCol("term"); updateGuidelinePos(e.currentTarget); } }}
                            onMouseLeave={() => { if (!resizingColKey) { setActiveHoverCol(null); setGuidelineX(null); } }}
                            className="absolute -right-2 top-0 bottom-0 w-4 cursor-col-resize select-none touch-none z-20"
                            title="열 너비 조절"
                          />
                        ...
                        >
                          ...
                          <div
                            onMouseDown={e => handleResizeStart(e, "status", (category === "SESSION" || (category === "ADV" && isWeekDirectEditable(selectedWeek) && selectedWeek !== 0)) ? 350 : 55)}
                        ...
                        <th style={{ width: `${colWidths.memo || 240}px`, minWidth: "220px" }} className="relative text-center px-3 py-1 text-slate-700 font-semibold">
                          <div className="h-9 flex items-center justify-center">비고</div>
                        </th>
                        {isTableEditMode && (
                          <th style={{ width: "40px" }} className="text-center px-1 py-1 text-slate-400 font-semibold w-10">
                    ...
                    <tbody className="divide-y divide-slate-100 font-mono">
                      {filteredAttendees.length === 0 ? (
                        ...
                        filteredAttendees.map(att => {
                          ...
                          const editDropdownStatuses: AttendStatus[] = category === "ADV"
                            ? [
                                "present",
                                "late",
                                "earlyLeave",
                          ...
                          const isDirectEditable = (category === "SESSION" || (category === "ADV" && isWeekDirectEditable(selectedWeek) && selectedWeek !== 0));

                          return (
                            <tr key={att.id} className="hover:bg-slate-50/70 transition-colors divide-x divide-slate-200 h-[42px]">
                              {selectedWeek === 0 && (
                                      ...
                                      {availableStatuses.map(s => {
                                        ...
                                        return (
                                          <button
                                            key={s}
                                            type="button"
                                            onClick={() => handleStatusChange(att.originalId || att.id, s, att.weekNum)}
                                            className={`py-1 text-[10px] sm:text-[11px] font-medium rounded transition-all cursor-pointer text-center whitespace-nowrap px-0.5 ${
                                              active ? ATTEND_STATUS_STYLES[s].active : ATTEND_STATUS_STYLES[s].inactive
                                            }`}
                                          >
                                  ...
                                  <div className="flex items-center justify-center w-full">
                                    <div className="relative w-[70px] h-[30px] flex items-center justify-center">
                                      <select
                                        ...
                                        onChange={e => handleStatusChange(att.originalId || att.id, e.target.value as AttendStatus, att.weekNum)}
                                        className="w-full h-full appearance-none text-center text-xs font-semibold text-slate-900 bg-white border border-slate-300 hover:border-blue-500 focus:border-blue-600 focus:ring-1 focus:ring-blue-600 rounded-lg outline-none cursor-pointer px-1.5 shadow-2xs transition-colors"
                                      >
                                        {editDropdownStatuses.map(s => (
                                          <option key={s} value={s} className="text-slate-900 font-medium">
                                ...
                                <td className="relative px-2 py-1.5 text-center whitespace-nowrap">
                                  <div className="flex items-center justify-center w-full">
                                    <div className="relative w-[70px] h-[30px] flex items-center justify-center">
                                      ...
                                      >
                                        {att.status === "unmarked" ? "—" : ATTEND_STATUS_CFG[att.status]?.label || att.status}
                                      </span>
                                    </div>
                                  </div>
                                </td>
                              ...
                              {(category === "SESSION" || (category === "ADV" && isWeekDirectEditable(selectedWeek) && selectedWeek !== 0)) ? (
                                <td className="relative px-3 py-2 text-center">
                                  <div className="h-8 flex items-center justify-center">
                                    <input
                                      type="text"
                                      value={att.memo || ""}
                                      onChange={e => handleMemoChange(att.originalId || att.id, e.target.value, att.weekNum)}
                                      placeholder="—"
                                ...
                                <td className="relative px-3 py-2 text-center text-slate-600 text-xs font-sans truncate" title={att.memo}>
                                  <div className="h-8 flex items-center justify-center">
          ...
          <div className="w-full max-w-lg rounded-2xl overflow-hidden p-6 space-y-4 bg-white border border-slate-200 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold text-slate-900">새 {config.title.split(" ")[0]} 회차 생성</h3>
              </div>
              <button onClick={() => setShowNewEventModal(false)} className="text-slate-400 hover:text-slate-700 cursor-pointer">
                <X size={16} />
              </button>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="p-3 text-white flex items-center justify-between text-xs font-medium">
              ...
              <span className="text-slate-400">{selectedEvent.title} ({selectedEvent.date})</span>
            </div>
          </div>
        </div>
      )}
            ...
            <div className="p-6 overflow-y-auto space-y-5 flex-1 min-h-0 text-xs">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between px-0.5">
                          ...
                          <Edit3 size={11} className="text-slate-400 group-hover:text-blue-500 transition-colors" />
                        </div>
              ...
              <div className="space-y-2.5 pt-2">
                ...
                <div className="flex flex-wrap items-center gap-x-3.5 gap-y-1 text-[11px] text-slate-500 px-0.5">
                  <span>출석 <strong className="text-slate-900 font-bold font-mono">1</strong></span>
                  <span>지각 <strong className="text-slate-900 font-bold font-mono">2</strong></span>
                  <span>조퇴 <strong className="text-slate-900 font-bold font-mono">3</strong></span>
                  <span>결석 <strong className="text-slate-900 font-bold font-mono">4</strong></span>
                  <span>인정결석 <strong className="text-slate-900 font-bold font-mono">5</strong></span>
                  <span>비대면 <strong className="text-slate-900 font-bold font-mono">6</strong></span>
                  <span className="text-slate-300 font-normal">|</span>
                  <span>무단지각 <strong className="text-slate-900 font-bold font-mono">0</strong></span>
                  <span>무단결석 <strong className="text-slate-900 font-bold font-mono">X</strong></span>
                </div>
                ...
                <div className="rounded-xl border border-slate-200 bg-white overflow-x-auto shadow-2xs">
                  <table className="w-full text-xs border-collapse table-auto whitespace-nowrap" style={{ minWidth: "1150px" }}>
                    <thead className="select-none divide-x divide-slate-200 border-b border-slate-200">
                      <tr className="h-10">
                        <th className="w-10 text-center py-2 px-1 text-slate-400 font-mono font-medium bg-slate-50">#</th>
                        {activeModalCols.map((col, idx) => {
                          const isBeingDragged = draggedColIdx === idx;
                          const isDropLeft = dropTarget?.index === idx && dropTarget?.position === "left";
                          const isDropRight = dropTarget?.index === idx && dropTarget?.position === "right";

                          const headerBg =
                            col.id === "absence" ? "bg-pink-100/90 text-slate-800" :
                            col.id === "unexcusedAbsence" ? "bg-red-200/90 text-slate-900" :
                            col.id === "lateEarlyLeave" ? "bg-amber-100 text-slate-800" :
                            col.id === "remote" ? "bg-indigo-100 text-slate-800" :
                            col.id === "totalScore" ? "bg-slate-100/90 text-slate-900" :
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex items-center justify-center">
                                <span className="font-bold text-xs leading-none whitespace-nowrap">{col.label}</span>
                              </div>
                            </th>
                          );
                        })}
                    ...
                    <tbody className="divide-y divide-slate-100 font-sans text-xs">
                      {previewRows.slice(0, 5).map((row: any, rIdx: number) => (
                        <tr key={row.id || rIdx} className="h-9 hover:bg-slate-50/70 transition-colors divide-x divide-slate-100">
                          <td className="text-center text-slate-400 font-mono text-xs px-1">{rIdx + 1}</td>
                          {activeModalCols.map(col => (
                            <td key={col.id} className={`text-center px-2.5 py-1.5 whitespace-nowrap ${col.id === "totalScore" ? "bg-slate-50/50 font-bold" : ""}`}>
                              {col.renderCell(row)}
                            </td>
                          ))}
                        </tr>
